...
public class BillingGrpcService extends BillingServiceGrpc.BillingServiceImplBase {
    ...
    public void createBillingAccount(
            ...
            /*once we're ready to respond for the request, we use StreamObserver which is a powerful concept in gRPC as it allows to earn multiple responses to the client at the same time, & also accept back-forth communication to that client*/
